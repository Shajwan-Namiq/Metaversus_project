      ...
      <section className={` relative z-10`}>
        ...
        >
          ...
          >
            ...
            >
              <span className="font-extrabold">Metaverse</span> is a new thing
              in the future, where you can enjoy the virtual world by feeling
              ...
              of today, using only <span className="font-extrabold">
                VR
              </span>{" "}
